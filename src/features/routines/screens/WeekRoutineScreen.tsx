...
import { WEEKDAYS, WEEKDAY_LABELS } from '@app-types/routine';
...
export default function WeekRoutineScreen() {
  ...
  const hasRoutine = !!bundle?.assignment && !!bundle?.routine;
      ...
      >
        {!hasRoutine ? (
          <EmptyState
            ...
            description="Tu rutina semanal aparecerá aquí cuando te la asignen."
          />
        ) : (
          <>
            <Text style={styles.routineName}>{bundle?.routine?.name}</Text>
